...
for "_i" from 1 to _rndOp1 do {
	...
	_pos = [RGG_patrol_obj, 0, 80] call BIS_fnc_findSafePos; // was 30, now 80, hopefully for better dispertion 
...
systemChat "opfor wave 1 spawn completed";
...
/*
Note, these opfor units will head to the patrol origin .. there is a chance they will not engage with the blufor units heading in 